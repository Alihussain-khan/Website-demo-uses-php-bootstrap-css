...
<html>
<head>
	<title>Electric Cars, Solar & Clean Energy | Charging</title>
	<meta charset="utf-8">
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images\charging.jpg" alt="Tesla Model 3" width="1100" height="500">   
	  <div class="carousel-caption" style="top: 40%; left: -40%;">
        <h3 style="color: white; font-weight: bold; font-size: 200%;">Charge Anywhere</h3>
        <p style="color: white; font-size: 170%;">Your Tesla can charge anywhere—with<br> standard equipment<br> 
		and convenient options, <br>including our global charging networks.</p>
      </div>  
    </div>
  </div>
</div>
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images\charging 1.jpg" alt="Tesla Model 3" width="1100" height="500">   
	  <div class="carousel-caption" style="top: 70%; left: -30%;">
        <h3 style="color: white; font-weight: bold; font-size: 200%;">Where You Park</h3>
        <p style="color: white; font-size: 170%;">Stay charged wherever you normally park—overnight at home, 
		<br>during the day at your workplace, or around the city.</p>
      </div>  
    </div>
  </div>
</div>
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images\charging 2.jpg" alt="Tesla Model 3" width="1100" height="500">   
	  <div class="carousel-caption" style="top: 70%; left: -30%;">
        <h3 style="color: white; font-weight: bold; font-size: 200%;">On the Road</h3>
        <p style="color: white; font-size: 170%;">Stop at a Supercharger while you take a quick break.
		<br>Long distance travel is easy with access<br> to the world’s fastest charging network.</p>
      </div>  
    </div>
  </div>
</div>
