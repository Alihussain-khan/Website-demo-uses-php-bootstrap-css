...
<html>
<head>
	<title>Electric Cars, Solar & Clean Energy | Goals</title>
	<meta charset="utf-8">
...
<div class="row py-3">
	...
	<img src="images\Goals.jpg" class="img-fluid "></img>
    </div>
    <div class="col-lg-6 col-md-6 col-12 ">
	<h3>Our Goals</h3>
	<p style="font-size:120%" class="py-5" >Tesla's mission is to accelerate the world's transition to sustainable energy.
