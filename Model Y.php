...
<html>
<head>
	<title>Electric Cars, Solar & Clean Energy | Model Y</title>
	<meta charset="utf-8">
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images\model Yz.jpg" alt="Tesla Model 3" width="1100" height="500">
      <div class="carousel-caption" style="  top: 70px; bottom: auto;">
        <h3 style="color: black; font-weight: bold; font-size: 250%;">Tesla Model Y</h3>
        <p style="color: black; font-weight: bold;">Hot Hatchback</p>
      </div>    
	    <div class="carousel-caption" style="top: 30%; left: 75%;">
        <h3 style="color: black; font-weight: bold; font-size: 200%; ">1.9 m^3</h3>
        <p style="color: black; font-weight: bold;">Cargo Space</p>
      </div>   
	  <div class="carousel-caption" style="top: 50%; left: 75%; ">
        <h3 style="color: black; font-weight: bold; font-size: 200%;">505 km</h3>
        <p style="color: black; font-weight: bold;">Range (est)</p>
      </div>  
	  <div class="carousel-caption" style="top: 70%; left: 75%;">
        <h3 style="color: black; font-weight: bold; font-size: 200%;">Awd</h3>
        <p style="color: black; font-weight: bold;">Drive Train</p>
      </div>      
    </div>
  </div>
</div>
...
<div class="row">
	...
	<img src="images\model Y6.jpg" class="img-fluid"></img>
    </div>
    <div class="col-lg-6 col-md-6 col-12">
...
<div class="row">
  <div class="col-lg-6 col-md-6 col-12 py-5">
	...
	<div class="col-lg-6 col-md-6 col-12">
	<img src="images\model Y7.jpg" class="img-fluid"></img>
    </div>
</div>
</div>
<br>
...
<div class="row">
	<div class="col-lg-6 col-md-6 col-12">
	<img src="images\model Y8.jpg" class="img-fluid"></img>
    </div>
    <div class="col-lg-6 col-md-6 col-12 py-5">
